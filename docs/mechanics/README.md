...
| [verification.md](verification.md) | The fact-verification policy — dictionary-verified, tutor-confirmed, or visibly marked; marks are claims; a dispute is a check |
